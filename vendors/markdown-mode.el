...
(defun markdown-insert-inline-mathjax ()
  "Insert markup for an inline mathjax code"
  (interactive)
  (markdown-wrap-or-insert "`\\\(" "\\\)`")
  (backward-char 3))

(defun markdown-insert-mathjax ()
  "Insert markup for mathjax code"
  (interactive)
  (markdown-wrap-or-insert "`\\\[" "\\\]`")
  (backward-char 3)
  (newline-and-indent))
...
(defvar markdown-mode-map
  (let ((map (make-keymap)))
    ...
    (define-key map "\C-c\C-si" 'markdown-insert-inline-mathjax)
    (define-key map "\C-c\C-sm" 'markdown-insert-mathjax)
...
(easy-menu-define markdown-mode-menu markdown-mode-map
  ...
  '("Markdown"
    ...
    ("MathJax"
     ["Inline Formula" markdown-insert-inline-mathjax]
     ["Block Formula" markdown-insert-mathjax])
    "---"
